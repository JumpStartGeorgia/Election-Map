ElectionMap::Application.routes.draw do
    ...
    # routes to root#index
		...
		match '/event_type/:event_type_id/event/:event_id/shape/:shape_id/shape_type/:shape_type_id/indicator_type/:indicator_type_id/view_type/:view_type(/custom_view/:custom_view(/highlight_shape/:highlight_shape))' => 'root#index', :as => 'summary_map', :via => :get
